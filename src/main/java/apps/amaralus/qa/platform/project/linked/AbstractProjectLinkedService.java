...
public abstract class AbstractProjectLinkedService<
        E extends IdSource<I>,
        M extends ProjectLinkedModel<I>,
        I>
        extends CrudService<E, M, I>
        implements ProjectLinkedService {
    ...
    public void deleteAllByProject() {
        repository.deleteAll(linkedRepository.findAllByProject(projectContext.getProjectId()));
    }
